"""
Django settings for instagramania project.
...
MANAGERS = ADMINS
EMAIL_SUBJECT_PREFIX = "[instagramania] "  # subject prefix for managers & admins

SESSION_COOKIE_NAME = "instagramania_ssid"
...
DATABASES = {
    ...
    "default": env.db_url(
        ...
        default="psql://{user}:{password}@{host}:{port}/{name}?sslmode={sslmode}".format(
            ...
            name=quote(env.str("DJANGO_DATABASE_NAME", default="instagramania")),
            user=quote(env.str("DJANGO_DATABASE_USER", default="instagramania")),
            password=quote(env.str("DJANGO_DATABASE_PASSWORD", default="instagramania")),
...
ROOT_URLCONF = "instagramania.urls"

WSGI_APPLICATION = "instagramania.wsgi.application"
...
# Email config
DEFAULT_FROM_EMAIL = "instagramania <info@TODO.com>"
SERVER_EMAIL = "instagramania server <server@TODO.com>"
