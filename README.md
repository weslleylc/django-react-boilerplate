...
Browser support is defined in the `instagramania/browserslist` file that is used for autoprefixing CSS.
...
|run psql                              |`make psql`                            |`docker-compose exec postgres psql --user instagramania --dbname instagramania` |


## Running commands on the server

    docker-compose -f docker-compose.production.yml run --rm --name instagramania_tmp django python manage.py <command>
...
- python: [`instagramania/cover`](./instagramania/cover)
